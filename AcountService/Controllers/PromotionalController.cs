...
namespace BanVatLieuXayDung.Controllers
{
    ...
    public class PromotionalController : ControllerBase
    {
        ...
        // GET api/<PromotionalController>/5
        [HttpGet("{productId}")]
        ...
        // POST api/<PromotionalController>
        [HttpPost]
        ...
        // PUT api/<PromotionalController>/5
        [HttpPut("{saleId}")]
        ...
        // DELETE api/<PromotionalController>/5
        [HttpDelete("{saleId}")]
